...
@WebServlet(name = "AvailableBoatsForActivityServlet", urlPatterns = {"/availableBoatsForActivity"})
public class AvailableBoatsForActivityServlet extends HttpServlet {
    @Override
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        getAvailableBoatsForReservationActivity(req, resp);
    }

    protected void getAvailableBoatsForReservationActivity(HttpServletRequest req, HttpServletResponse resp) throws IOException {
